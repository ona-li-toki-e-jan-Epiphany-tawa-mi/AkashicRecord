...
#Grants Advancement
execute at @e[type=chicken,tag=glowingChicken,scores={glowTimer=1}] as @a[distance=..6] run advancement grant @s only darkathame_comp1_13:shittymcadvancements/glowingchickens
#Reset
