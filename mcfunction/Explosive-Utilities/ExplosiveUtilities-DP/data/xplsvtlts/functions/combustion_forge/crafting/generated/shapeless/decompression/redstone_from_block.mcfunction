...
execute if block ^-1 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:redstone_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^0 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:redstone_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^1 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:redstone_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^-1 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:redstone_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^0 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:redstone_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^1 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:redstone_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^-1 ^1 ^1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:redstone_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^0 ^1 ^1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:redstone_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^1 ^1 ^1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:redstone_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
...
execute if score _valid_ingredient_count xplsvtlts matches 2 run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:redstone",Count:9b}}
execute if score _valid_ingredient_count xplsvtlts matches 2 run scoreboard players add _items_crafted xplsvtlts 1
execute if score _valid_ingredient_count xplsvtlts matches 2 run function xplsvtlts:combustion_forge/crafting/generated/shapeless/decompression/redstone_from_block
