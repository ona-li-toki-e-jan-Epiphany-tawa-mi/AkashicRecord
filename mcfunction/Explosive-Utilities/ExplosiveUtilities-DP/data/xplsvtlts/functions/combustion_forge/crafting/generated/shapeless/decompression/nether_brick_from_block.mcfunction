...
execute if block ^-1 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:nether_bricks"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^0 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:nether_bricks"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^1 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:nether_bricks"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^-1 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:nether_bricks"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^0 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:nether_bricks"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^1 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:nether_bricks"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^-1 ^1 ^1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:nether_bricks"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^0 ^1 ^1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:nether_bricks"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^1 ^1 ^1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:nether_bricks"}]} run scoreboard players add _item_1_count xplsvtlts 1
...
execute if score _valid_ingredient_count xplsvtlts matches 2 run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:nether_brick",Count:4b}}
execute if score _valid_ingredient_count xplsvtlts matches 2 run scoreboard players add _items_crafted xplsvtlts 1
execute if score _valid_ingredient_count xplsvtlts matches 2 run function xplsvtlts:combustion_forge/crafting/generated/shapeless/decompression/nether_brick_from_block
