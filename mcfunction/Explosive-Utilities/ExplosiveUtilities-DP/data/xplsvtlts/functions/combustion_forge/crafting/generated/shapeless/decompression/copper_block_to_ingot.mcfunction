...
execute if block ^-1 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^-1 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:waxed_copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^0 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^0 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:waxed_copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^1 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^1 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:waxed_copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^-1 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^-1 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:waxed_copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^0 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^0 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:waxed_copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^1 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^1 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:waxed_copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^-1 ^1 ^1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
execute if block ^-1 ^1 ^1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:waxed_copper_block"}]} run scoreboard players add _item_1_count xplsvtlts 1
...
execute if score _valid_ingredient_count xplsvtlts matches 2 run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:copper_ingot",Count:9b}}
execute if score _valid_ingredient_count xplsvtlts matches 2 run scoreboard players add _items_crafted xplsvtlts 1
execute if score _valid_ingredient_count xplsvtlts matches 2 run function xplsvtlts:combustion_forge/crafting/generated/shapeless/decompression/copper_block_to_ingot
