...
execute if block ^1 ^1 ^-1 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:tnt"}]} run scoreboard players add _valid_ingredient_count xplsvtlts 1
...
execute if block ^0 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:totem_of_undying"}]} run scoreboard players add _valid_ingredient_count xplsvtlts 1
execute if block ^1 ^1 ^0 minecraft:furnace{Items:[{Slot:0b,id:"minecraft:stick"}]} run scoreboard players add _valid_ingredient_count xplsvtlts 1
...
execute if score _valid_ingredient_count xplsvtlts matches 9 run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone_pickaxe",Count:1b,tag:{CustomModelData:7106215,display:{Name:'{"text":"Tnt Wand","italic":false,"color":"yellow"}',Lore:['{"text":"Explosive Utilities","italic":false,"color":"blue"}']},Unbreakable:true}}}
execute if score _valid_ingredient_count xplsvtlts matches 9 run scoreboard players add _items_crafted xplsvtlts 1
execute if score _valid_ingredient_count xplsvtlts matches 9 run function xplsvtlts:combustion_forge/crafting/generated/shaped/tnt_wand
